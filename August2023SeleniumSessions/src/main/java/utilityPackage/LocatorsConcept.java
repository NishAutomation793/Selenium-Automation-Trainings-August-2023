...
public class LocatorsConcept {
	...
	public static void main(String[] args) {
		...
		// create the webelement + perform an action(click, sendKeys, getText,
		// isDisplayed)
		...
		// 4. xpath: not an attribute. this is the address of the element in the HTML
		// DOM.
...
//				doClick(loginBtn);
		...
		// 6. linkText: only for links. link text is not an attribute, this is the text
		// of the link
